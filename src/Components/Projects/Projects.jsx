...
const Projects = () => {
  return (
    <section className="py-16 px-4 md:px-12 lg:px-36 bg-black border-t border-gray-700 text-white">
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div key={project.id} className="bg-black p-4 rounded-lg shadow-lg border border-gray-700 hover:border-gray-400 transition-colors duration-300">
              <img src={project.image} alt={project.title} className="w-full hover:scale-95 transition-transform duration-700 h-40 object-cover mb-4 rounded" />
