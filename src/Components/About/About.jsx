...
const About = () => {
  return (
    <div className="min-h-96 px-5 md:px-0 flex flex-col md:flex-row md:pt-16 justify-between items-center bg-black text-white">
      ...
      <div className="w-full md:w-1/2 max-w-3xl md:py-8 md:pl-10 space-y-6">
