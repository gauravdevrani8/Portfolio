...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-transparent fixed top-0 left-0 w-[100%] z-50 backdrop-blur-md shadow-md text-gray-50">
        <nav className="container mx-auto px-4 md:px-28 py-3 md:py-4 flex justify-between items-center">
          ...
          <Link to="/contact" className="hidden md:block">
            <button className="border hover:bg-green-300 hover:text-black transition duration-300 font-poppins text-white py-2 px-4 rounded">
              Contact
            </button>
          </Link>
        </nav>
